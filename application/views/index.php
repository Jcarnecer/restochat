...
<html>
    <head>
        ...
        <title>Chat</title>
        <base href="<?= base_url() ?>" />
        <link rel="stylesheet" type="text/css" href="http://restoshift.com/assets/css/flavored-reset-and-normalize.css" />
        <link rel="stylesheet" type="text/css" href="http://restoshift.com/assets/css/bootstrap.css" />
        <link rel="stylesheet" type="text/css" href="http://restoshift.com/assets/css/font-awesome.min.css" />
        <link rel="stylesheet" type="text/css" href="http://restoshift.com/assets/css/styles.css" />
    ...
    <body>
        ...
        <script src="http://restoshift.com/assets/js/jquery.js"></script>
        <script src="http://restoshift.com/assets/js/popper.min.js"></script>
        <script src="http://restoshift.com/assets/js/bootstrap.min.js"></script>
        <script src="http://restoshift.com/assets/js/jquery.nicescroll.min.js"></script>
        <script src="http://restoshift.com/assets/js/script.js"></script>
